...
"}")
        ...
        self.volume_group = QtWidgets.QGroupBox(parent=self.centralwidget)
        ...
        self.volume_button = QtWidgets.QCheckBox(parent=self.volume_group)
        ...
        self.hist_group = QtWidgets.QGroupBox(parent=self.volume_group)
        self.hist_group.setEnabled(False)
        self.hist_group.setTitle("")
        ...
        self.func_layout.addLayout(self.horizontalLayout_5, 2, 0, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=self.hist_group)
        self.label_3.setObjectName("label_3")
        self.func_layout.addWidget(self.label_3, 0, 0, 1, 1)
        ...
        self.func_layout.addWidget(self.update_button, 2, 1, 1, 1)
        self.hist_layout = QtWidgets.QVBoxLayout()
        self.hist_layout.setObjectName("hist_layout")
        self.func_layout.addLayout(self.hist_layout, 1, 0, 1, 1)
        ...
        self.func_layout.addLayout(self.verticalLayout_6, 1, 1, 1, 1)
        self.verticalLayout_4.addLayout(self.func_layout)
        self.verticalLayout.addWidget(self.hist_group)
        self.user_frame.addWidget(self.volume_group)
        spacerItem2 = QtWidgets.QSpacerItem(468, 13, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.user_frame.addItem(spacerItem2)
        ...
        self.menuAbout.setGeometry(QtCore.QRect(240, 203, 142, 68))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Histogram and opacity function"))
